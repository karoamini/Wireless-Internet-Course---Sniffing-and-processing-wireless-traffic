...
#load OUT list: this is useful for understanding the vendor. the first 3 bytes of each MAC address are assigned to the manufacturer.
f = open('oui.txt','r')
vendor_mac = []
vendor_name = []
for line in f:
...
#load file
cap = pyshark.FileCapture('office_capture/office_capture_probes_only.pcapng')
